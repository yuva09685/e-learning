...
const features = [
  {
    ...
    title: 'Expert Tutors',
    description: 'Our instructors are industry leaders with a passion for sharing knowledge and mentoring students.'
  },
  {
    icon: (
  ...
  },
  {
    ...
    description: 'We provide one-on-one guidance to help you navigate your career path and achieve your goals.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Our dedicated placement cell offers resume building, interview prep, and networking opportunities.'
  },
];
    ...
    <section id="features" className="py-20 bg-brand-light">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-brand-primary">Why Choose suyam's IIMT institute?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="group relative bg-white p-8 rounded-lg shadow-lg text-center transform transition-all hover:scale-105 hover:shadow-2xl overflow-hidden">
              <div className="inline-block bg-brand-secondary text-white p-4 rounded-full mb-4">
                {feature.icon}
              </div>
