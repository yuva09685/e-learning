    ...
    <div className="bg-brand-light min-h-screen pt-24 pb-12">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Information We Collect</h2>
          ...
          <h3 className="text-xl font-bold text-brand-primary mt-6 mb-2">Personal Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-bold text-brand-primary mt-6 mb-2">Usage Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Data Security</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Service Providers</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Links to Other Sites</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Children's Privacy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Changes to This Privacy Policy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-primary mt-8 mb-4">Contact Us</h2>
          <p className="text-gray-700 mb-6">
