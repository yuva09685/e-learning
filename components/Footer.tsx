        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="https://maps.google.com/?q=123+Education+Lane,+Knowledge+City" target="_blank" rel="noopener noreferrer" className="hover:text-white">123 Education Lane, Knowledge City</a></li>
            </ul>
          </div>
          <div>
